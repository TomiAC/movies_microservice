...
async def update_director_endpoint(director_id: str, director: DirectorUpdate, db: Session = Depends(get_db)):
...
async def delete_director_endpoint(director_id: str, db: Session = Depends(get_db)):
